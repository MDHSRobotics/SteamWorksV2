...
public class PlaceGearCommand extends MDCommand {
	...
	public PlaceGearCommand(MDRobotBase robot, String name, boolean goForward) {
		super(robot, name);
	...
	protected boolean isFinished() {
		if(goForward) {
			return gearSubsystem.getActualDistance() <= autoSubsystem.getgearStopDistance();
		} 
		else {
			return gearSubsystem.getActualDistance() >= autoSubsystem.getgearBackupDistance();
		}
